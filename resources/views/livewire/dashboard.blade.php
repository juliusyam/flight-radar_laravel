    ...
    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
        ...
        >
            ...
            <div class="pt-3 sm:pt-5">
                ...
                <p class="mt-4 text-sm/relaxed">
                    Click here for a nice surprise. I promise this isn't a silly prank like redirecting to the Rick
                    Astley music video of Never Gonna Give You Up on YouTube.
                </p>
            </div>
        ...
        >
            ...
            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black dark:text-white">Livewire Hello World - Reactive
                    Components</h2>
